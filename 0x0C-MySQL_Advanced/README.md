...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/HBkS6pRBQkrj7LsQchdecg "explain to anyone"), **without the help of Google**:
...
-   Import this table dump: [metal_bands.sql.zip](https://intranet.hbtn.io/rltoken/G_M3wWkUh8Aemw6-LlxtZQ "metal_bands.sql.zip")
...
-   Import this table dump: [names.sql.zip](https://intranet.hbtn.io/rltoken/KOK9vOWR6h1rOgrALLNGPw "names.sql.zip")
...
-   [Calculate-Weighted-Average](https://intranet.hbtn.io/rltoken/4fHYP9T61Gfhv8dHZ7tMBg "Calculate-Weighted-Average")
